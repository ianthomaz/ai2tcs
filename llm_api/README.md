...
- **Documentação** – pasta [`../docs/`](../docs/) na raiz do repositório: [01-overview.md](../docs/01-overview.md), [02-api-integration.md](../docs/02-api-integration.md), etc. (atalho: [`docs/README.md`](docs/README.md) explica o redirect)
