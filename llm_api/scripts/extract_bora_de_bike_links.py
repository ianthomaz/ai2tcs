...
Usage:
  cd llm_api && python scripts/extract_bora_de_bike_links.py

Requires: API running (uvicorn), Ollama. Default: localhost:28471. For prod set NF_EXTRACT_BASE to your public API base URL (HTTPS).
"""
