...
- Documentação (`02-api-integration.md`)
...
**Status:** Planning
- Consolidar e limpar `02-api-integration.md`
...
2. Refatorar `02-api-integration.md`
...
3. Consolidar `docs/refs/operacao-tailscale.md` em apêndice

**Impacto esperado:** 30% menos tempo de onboarding para novos projetos

---

### ✅ Nível 2: Criar 04-developer-guide.md
...
Março 2026
  └─ ✅ Nível 1: Temperature + top_k + repeat_penalty
     ...
     ✅ Documentação: UPGRADES.md + 04-developer-guide.md
...
Notas detalhadas, checklist de entregas e perguntas para fechar o desenho: [../docs/10-historical-router-plan.md](../docs/10-historical-router-plan.md).
...
Veja `04-developer-guide.md` para padrões de código, ou contacte `@ianthomaz` no repositório.
