# Plano — Fleet de LLMs, Router triage-first, Chaves por projeto, Ingest partilhado e ADM
...
**Relacionado:** [OPERACAO_TAILSCALE.md](./OPERACAO_TAILSCALE.md), [MANUAL_INTEGRACAO.md](./MANUAL_INTEGRACAO.md), [UPGRADE_MODELO_LLM.md](./UPGRADE_MODELO_LLM.md), [UPGRADES.md](../UPGRADES.md), `app/api/message_router.py`, `app/config.py`, `prisma/schema.prisma`.
...
- [MANUAL_INTEGRACAO.md](./MANUAL_INTEGRACAO.md) — documentar que `model` no body aceita os 4 aliases.
...
Ver [OPERACAO_TAILSCALE.md](./OPERACAO_TAILSCALE.md) para detalhes de rede.

---

## 8. Manual de reintegração

Novo documento [MANUAL_REINTEGRACAO.md](./MANUAL_REINTEGRACAO.md) (ou secção dedicada em [MANUAL_INTEGRACAO.md](./MANUAL_INTEGRACAO.md)) com:
...
| E12 | [MANUAL_REINTEGRACAO.md](./MANUAL_REINTEGRACAO.md) + atualização de [INDEX.md](./INDEX.md) e [MANUAL_INTEGRACAO.md](./MANUAL_INTEGRACAO.md) | E7, E8, E11 |
...
- **E12 (docs):** `MANUAL_REINTEGRACAO.md` existe, linkado em `INDEX.md`; exemplos curl funcionam como descritos.
