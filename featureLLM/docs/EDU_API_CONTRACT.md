# Educational API Contract — Eixo /edu/*
...
Este ficheiro faz parte do repositório **ai2tcs**, em `featureLLM/docs/`.

**Integração:** URL base, autenticação Bearer e visão geral dos endpoints na mesma API que o resto do serviço — ver [MANUAL_INTEGRACAO.md](./MANUAL_INTEGRACAO.md) § 3.8 e § 2.
