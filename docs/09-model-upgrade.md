...
| (ExtratNFdata standalone) | `features/ExtratNFdata/` | Mesmo conceito, outro projeto |
...
| [02-api-integration.md](./02-api-integration.md) | Documentar `OLLAMA_CHAT_MODEL` |
| [08-project-config.md](./08-project-config.md) | Se implementar override por projeto |
...
6. Documentar em [02-api-integration.md](./02-api-integration.md).
...
3. Documentar em [08-project-config.md](./08-project-config.md).
...
- Upgrade roadmap: [UPGRADES.md](../llm_api/UPGRADES.md)
- Config por projeto: [08-project-config.md](./08-project-config.md)
- Calibração: [07-llm-calibration.md](./07-llm-calibration.md)

---

**Anterior:** [08-project-config.md](./08-project-config.md) · **Seguinte:** [10-historical-router-plan.md](./10-historical-router-plan.md)
